...
public class SizeConstraintValidator implements ConstraintValidator {
	...
	private int getSize(Object fieldValue) {
		if (fieldValue instanceof String) {
			return ((String)fieldValue).codePointCount(0, ((String)fieldValue).length());
			...
			throw new RuntimeException("me.geso.tinyvalidator.rules.SizeConstraintValidator can't get a size from: "
				+ fieldValue.getClass());
		}
	}
